...
In this project, I designed stress tests with different number of trasaction and number of threads (number of p_thread in C or thread number assigned to OpenMP in C++). This result is shown below:
